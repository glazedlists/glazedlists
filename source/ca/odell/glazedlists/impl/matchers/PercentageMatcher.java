 ...
 */
public class PercentageMatcher extends CompositeMatcher {
     ...
     */
    public PercentageMatcher(double percentage_required, Matcher one, Matcher two) {
        super(one, two);
     ...
     * @param percentage_required See {@link #setPercentageRequired(double)}
     */
    public PercentageMatcher(double percentage_required, Matcher[] matchers) {
        super(matchers);
     ...
     * @param percentage_required See {@link #setPercentageRequired(double)}
     */
    public PercentageMatcher(double percentage_required, EventList matcher_list) {
        super(matcher_list);
