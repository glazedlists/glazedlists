 ...
 */
public class EventListMatcher extends AbstractMatcher implements ListEventListener {
     ...
     */
    public EventListMatcher(EventList match_set) {
        this(match_set, true);
    }
     ...
     */
    public EventListMatcher(EventList match_set, boolean match_in_list) {
