 ...
 * found <a href="http://code.google.com/p/google-guice/source/browse/trunk/src/com/google/inject/internal/TypeResolver.java">here</a>.
 *
...
final class TypeResolver {
    ...
    private final Map<FqTypeVar, Type> index = new HashMap<FqTypeVar, Type>();

    /** types to resolved types */
    private final Map<Type, Type> cache = new HashMap<Type, Type>();

    /** raw supertypes to the corresponding resolved generic types */
    private final Map<Class<?>, Type> implementedTypes = new HashMap<Class<?>, Type>();
    ...
    private Type resolve(Type type) {
        ...
        if (type instanceof ParameterizedType) {
            ...
            Type resolved = Types.newParameterizedTypeWithOwner(resolvedOwnerType, resolvedRawType, resolvedArguments);
