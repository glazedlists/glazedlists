...
class PriorityTableCellRenderer extends DefaultTableCellRenderer {
	...
	public Component getTableCellRendererComponent(JTable table, Object value,
        ...
        // ... otherwise, draw with a colored foreground
			...
			if(value.equals(Priority.P1)) component.setForeground(P1_COLOR);
			else if(value.equals(Priority.P2)) component.setForeground(P2_COLOR);
			else if(value.equals(Priority.P3)) component.setForeground(P3_COLOR);
			else if(value.equals(Priority.P4)) component.setForeground(P4_COLOR);
			else if(value.equals(Priority.P5)) component.setForeground(P5_COLOR);
			else component.setForeground(default_foreground);	// unknown
		}
