...
public class Issue implements TextFilterable, Comparable {
    ...
    public static List loadIssues() {
        ...
        currentIssue.id = new Integer(1);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P3";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        currentIssue.version = "current";
        currentIssue.assignedTo = "jessewilson";
        currentIssue.subcomponent = "www";
        currentIssue.issueType = "TASK";
        currentIssue.qaContact = "issues@glazedlists";
        currentIssue.shortDescription = "Improve filter performance upon list change";
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "The current implementation of filtering uses a N*N*M algorithm to re-filter when the list \nchanges, for M changes on a list of size N.\n\nIt is necessary to improve this runtime by using more appropriate data structures inside \nthe AbstractFilterList.";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "Created an attachment (id=1)\nscreenshot from profiler\n";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "In creating a test case I found that the filter performance can be really bad in certain situations.\n\nI think this case can be justification for updating the AbstractFilterList to use a SparseList instead of the \ncurrent arraylist hack.";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "I have changed the AbstractFilterList to use SparseList instead of the hack array data structure. The \nresults are impressive in some cases only and not noticable in other cases. This change will cause \nchange events to be orders of magnitude faster, while get() events will be slightly slower.\n\nHere is the results in elapsed time from two tests I ran, before and after the fix:\nCaseInsensitiveFilterListTest\nbefore: 3.9s\nafter: 2.8s\n\nMultipleListenersTest\nbefore: 162.9s\nafter: 19.2s";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "This bug has been fixed for two weeks with no problems. I am marking it closed.";
        currentIssue.getDescriptions().add(description);
        description = null;
        issues.add(currentIssue);
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(2);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P2";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        currentIssue.version = "current";
        currentIssue.assignedTo = "jessewilson";
        currentIssue.subcomponent = "www";
        currentIssue.issueType = "DEFECT";
        currentIssue.qaContact = "issues@glazedlists";
        currentIssue.shortDescription = "Filter regex fails with special characters";
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "The current filter code for CaseInsensitiveFilterList fails to work when the filter text \ncontains regular-expression characters such as dot.\n\nFix this to handle special characters as they should be.";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "Fixed in CVS. Added a method getMatcher() that constructs a matcher using the source \nstring";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(6);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P3";
        currentIssue.resolution = "INVALID";
        currentIssue.component = "glazedlists";
        currentIssue.version = "current";
        currentIssue.assignedTo = "issues@glazedlists";
        currentIssue.subcomponent = "www";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(10);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P3";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(11);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P3";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(12);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P3";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(13);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P3";
        currentIssue.resolution = "INVALID";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(14);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P3";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(15);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P3";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(16);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P3";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue.issueType = "DEFECT";
        currentIssue.qaContact = "issues@glazedlists";
        currentIssue.shortDescription = "No removeSelectionListener() method in ListTable";
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        ...
        description.who = "jessewilson";
        description.when = null;
        description.text = "The method had been omitted in error.\n\nI have added it to the latest revision in CVS.";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(17);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P1";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        currentIssue.version = "current";
        currentIssue.assignedTo = "jessewilson";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(18);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P3";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(19);
        currentIssue.status = "NEW";
        currentIssue.priority = "P3";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(21);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P3";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(23);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P3";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(24);
        currentIssue.status = "NEW";
        currentIssue.priority = "P5";
        currentIssue.resolution = "";
        currentIssue.component = "glazedlists";
        ...
        currentIssue.issueType = "FEATURE";
        currentIssue.qaContact = "issues@glazedlists";
        currentIssue.shortDescription = "Add DeltaList for consistency with derivatives of WritableMutationList";
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "WritableMutationLists allow modifications to be made to the list that may behave differently than \nexpected. The solution is to implement a DeltaList, which is a mutation list that provides as-expected \nresults when they would not otherwise be possible.\n\nFrom issue 18:\n\nDaniel Bonin and I were discussing modifyable views and we came up with some observations. When \nusing FilterList, SortedList or the like, you can have inconsistent behaviour. For example, the following \ncode wil fail.\n\nlist x = ...\nx.add(0, \"Jesse\");\nassert(\"Jesse\".equals(x.get(0));\n\nThis can fail because the inserted value \"Jesse\" gets filtered out or sorted to a different location.\n\nOur solution: a happy list. The happy list \"fakes\" success as the method directed. It basically keeps \ntrack of local changes to make the changes appear consistent. This can be used with GUIs to allow the \nuser to verify their modifications without losing the filtering and sorting. \n\nThe happy list will be called \"DeltaList\" and it will keep track of both the source list and a set of deltas \nthat have been performed. When an insert at x occurs, the delta list simulates that the insert occured at \nx, even if the insert was sorted or filtered to a different location.";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "priority reduced as there is no 'customers' waiting for this feature.";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "This may be an excellent candidate as something to extend AbstractFilterList.";
        currentIssue.getDescriptions().add(description);
        description = null;
        issues.add(currentIssue);
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(25);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P3";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(26);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P3";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue.issueType = "DEFECT";
        currentIssue.qaContact = "issues@glazedlists";
        currentIssue.shortDescription = "Replace global lock with reader/writer locks";
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "The current Glazed Lists uses global locks for all reads and writes. It would higher performance to use a \nreader/writer lock instead.\n\nThe reader/writer lock could be either requested via eventList.getLock().aquireRead() or via \neventList.aquireReadLock(). I think I prefer using getLock(), which returns an object implementing a \nReaderWriterLock interface. That way I can easily swap out the lock implementation.";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "We've swapped the global synchronized on root list to global reader writer locks.\n\nWe can now replace that with local locks.";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "I am marking this problem as \"fixed\" and creating a new issue which covers concurrent mutationlist \nmodifications.";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(27);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P3";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(28);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P1";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(29);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P4";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        currentIssue.version = "current";
        currentIssue.assignedTo = "jessewilson";
        ...
        currentIssue.issueType = "DEFECT";
        currentIssue.qaContact = "issues@glazedlists";
        currentIssue.shortDescription = "ToString on BasicEventList, MutationList no good";
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "The toString value on Java Lists is like \"[lemon, orange, apple, banana]\"\nbut on Glazed Lists it is like \"com.odellengineeringltd.glazedlists.BasicEventList@f4d448ce\"";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "kevinmaltby";
        description.when = null;
        description.text = "The toString value on Glazed Lists is the same as the toString value on Java \nLists now.";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(30);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P4";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(31);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P2";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(32);
        currentIssue.status = "NEW";
        currentIssue.priority = "P5";
        currentIssue.resolution = "";
        currentIssue.component = "glazedlists";
        ...
        currentIssue.issueType = "ENHANCEMENT";
        currentIssue.qaContact = "issues@glazedlists";
        currentIssue.shortDescription = "SortedList raw order support";
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "SortedList should support raw order when the current comparator is NULL.";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "This is now high priority as it is needed for making TableComparatorChooser work better.";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(34);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P3";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(35);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P5";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue.issueType = "ENHANCEMENT";
        currentIssue.qaContact = "issues@glazedlists";
        currentIssue.shortDescription = "UniqueList needs a means of forwarding non-mandatory change events";
        description = new Description();
        description.who = "kevinmaltby";
        description.when = null;
        description.text = "UniqueList needs to provide access to non-mandatory change events for \noverlaying lists which want to listen to them.";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "This non-critical issue is being marked low-priority until Glazed Lists 1.0 has\nbeen released.";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "The solution is for UniqueList to use multiple ListEventAssemblers and to allow\nlisteners to choose which ListEventAssembler they subscribe to by overloading\nthe addListEventListener() method.";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(36);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P5";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(37);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P3";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(38);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P4";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue.issueType = "DEFECT";
        currentIssue.qaContact = "issues@glazedlists";
        currentIssue.shortDescription = "TableComparatorChooser icon can get out of sync";
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "When the sorting of a list changes, the TableComparatorChooser fails to respond to this change \nappropriately. The TableComparatorChooser should show the proper icon, even if the sorted list's \ncomparator was selected elsewhere.";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "kevinmaltby";
        description.when = null;
        description.text = "TableComparatorChooser now responds to sorting criteria changing externally.";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(39);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P2";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(40);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P2";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue.issueType = "DEFECT";
        currentIssue.qaContact = "issues@glazedlists";
        currentIssue.shortDescription = "Sorted List fails upon intensive filtering";
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "SortedList fails upon an intensive amount of filtering. The SortedListTest must be updated to catch this \nfailure and the SortedList should also be fixed to remedy the problem.\n\n    [junit] FILTER: 4, 5, 1, 6, 2, 3, 2, 8, 1, 3, \n    [junit] SORTED: 1, 1, 2, 3, 2, 3, 4, 8, 5, 6,";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "I was processing the events in the ListChangeEvent in a manner that was unsafe when there were \ninserts mixed with deletes.\n\nThe SortedList now fires all delete events first, and then goes on to handle the inserts and updates \nlater.\n";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(41);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P3";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(42);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P3";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue.issueType = "DEFECT";
        currentIssue.qaContact = "issues@glazedlists";
        currentIssue.shortDescription = "Enable concurrent mutation list modifications";
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "Currently the reader/writer locks lock ALL lists when any mutation list is being modified (ie. re-sorted).\n\nThe reader/writer locks should be changed to only lock dependent lists when such a modification takes \nplace.\n\nThis applies to:\n - AbstractFilterList\n - SortedList\n - UniqueList\n - CachingList\n - and potentially others";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "Fixed . . . now the SortedList and AbstractFilterList can sort or filter multiple lists with the same source \nsimultaneously. This uses the new InternalReadWriteLock which delegates locking to a pair of \nReadWriteLocks.";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(43);
        currentIssue.status = "NEW";
        currentIssue.priority = "P5";
        currentIssue.resolution = "";
        currentIssue.component = "glazedlists";
        ...
        currentIssue.issueType = "DEFECT";
        currentIssue.qaContact = "issues@glazedlists";
        currentIssue.shortDescription = "Potential deadlock in CachingList";
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "The CachingList acquires a WriteLock when it may already have a ReadLock.\n\nThis is DANGEROUS! It is possible that two CachingLists may each have readlocks, and contest over a \nwrite lock to their doom!";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "Simple solution: make CachingList.getReadLock() return the write lock.";
        currentIssue.getDescriptions().add(description);
        description = null;
        issues.add(currentIssue);
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(44);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P2";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(45);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P2";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(46);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P4";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue.issueType = "DEFECT";
        currentIssue.qaContact = "issues@glazedlists";
        currentIssue.shortDescription = "UniqueList, FilterList fire multiple events for some operations";
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "UniqueList.clear(), FilterList.clear(), SubList.clear() all can fire multiple ListEvents when only a single \noperation is performed upon them.\n\nThis can be fixed by causing such lists to not propogate changes until they are all done.";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "These lists now only fire one event for the said operations. A new test class\nhas also been added to verify this behaviour.";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(47);
        currentIssue.status = "STARTED";
        currentIssue.priority = "P5";
        currentIssue.resolution = "";
        currentIssue.component = "glazedlists";
        currentIssue.version = "current";
        ...
        currentIssue.issueType = "DEFECT";
        currentIssue.qaContact = "issues@glazedlists";
        currentIssue.shortDescription = "Migrationkit's DynamicQueryList fails to forward events";
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "The Migrationkit's DynamicQueryList class is not forwarding events.";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "This bug has already been fixed.\n\nThe fix is NOT in the Glazed Lists 0.9 release, but it will be in the next Glazed Lists release. The fix is \nalso available via CVS.";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(49);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P3";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(50);
        currentIssue.status = "STARTED";
        currentIssue.priority = "P5";
        currentIssue.resolution = "";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(53);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P3";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue.issueType = "DEFECT";
        currentIssue.qaContact = "issues@glazedlists";
        currentIssue.shortDescription = "Protected constructors on final classes";
        description = new Description();
        description.who = "kevinmaltby";
        description.when = null;
        description.text = "Both ReadOnlyList and ThreadSafeList have protected constructors.  This is most \nlikely in error, particularly because both classes are final.  These should be \nmade public (I would do it but my CVS still doesn't want to work at my new \nplace).";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "This was an easy fix. We have to get Kevin some CVS access!";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(54);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P2";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue.issueType = "DEFECT";
        currentIssue.qaContact = "issues@glazedlists";
        currentIssue.shortDescription = "EventSelectionModel does not support concurrency";
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "In implementing EventSelectionModel we made some incorrect assumptions about\nmultithreading. The problem is that although the accessing thead will usually be\nthe event dispatch thread, we must be able to read the model while another\nthread is modifying the source list.";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "I have added concurrency support with an Internal lock.";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(55);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P3";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(56);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P2";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue.issueType = "DEFECT";
        currentIssue.qaContact = "issues@glazedlists";
        currentIssue.shortDescription = "UniqueList replaceAll() can clear selection";
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "The replaceAll() method should use UPDATE events whenever possible.\nCurrently it forwards DELETE/INSERT events that can clear selection.\n\nIn order for UniqueList to completely replace query lists, this functionality is\nabsolutely mandatory.";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(57);
        currentIssue.status = "NEW";
        currentIssue.priority = "P3";
        currentIssue.resolution = "";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(59);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P3";
        currentIssue.resolution = "WORKSFORME";
        currentIssue.component = "glazedlists";
        currentIssue.version = "current";
        currentIssue.assignedTo = "issues@glazedlists";
        currentIssue.subcomponent = "www";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(60);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P3";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(61);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P5";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(62);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P4";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(63);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P5";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(64);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P3";
        currentIssue.resolution = "WORKSFORME";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(65);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P1";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(66);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P1";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(68);
        currentIssue.status = "NEW";
        currentIssue.priority = "P3";
        currentIssue.resolution = "";
        currentIssue.component = "glazedlists";
        ...
        currentIssue.issueType = "DEFECT";
        currentIssue.qaContact = "jessewilson";
        currentIssue.shortDescription = "Build fails on junit";
        description = new Description();
        description.who = "pkuzel";
        description.when = null;
        description.text = "Default target excludes *Test classes by there is one not folowing the pattren.\n\ncompile:\n    [mkdir] Created dir: /data/cvs/javanet/glazedlists/classes\n    [javac] Compiling 82 source files to /data/cvs/javanet/glazedlists/classes\n    [javac]\n/data/cvs/javanet/glazedlists/source/ca/odell/glazedlists/test/ThreadedCompositeRunner.java:10:\npackage junit.framework does not exist\n    [javac] import junit.framework.*;\n    [javac] ^\n    [javac] Note: Some input files use or override a deprecated API.\n    [javac] Note: Recompile with -deprecation for details.\n    [javac] 1 error";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "pkuzel";
        description.when = null;
        description.text = "Created an attachment (id=3)\nA simple patch\n";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "This was a total oversight on my behalf and has now been resolved.";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(70);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P2";
        currentIssue.resolution = "INVALID";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(71);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P2";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(72);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P3";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(73);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P2";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(77);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P2";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue.issueType = "DEFECT";
        currentIssue.qaContact = "jessewilson";
        currentIssue.shortDescription = "TableHeader indicator arrows point the wrong way";
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "Compare table header indicator arrows between Glazed Lists' TableComparatorChooser and native \napps. Glazed Lists' arrows point up when down and vice-versa. This should be verified on other \nplatforms!";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "This was just a silly missing exclamation mark, as in if(isReverse()) should have been if(!isReverse())\n\nAn embarassing mistake to say the least. How come nobody caught this earlier!";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(78);
        currentIssue.status = "CLOSED";
        currentIssue.priority = "P2";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
        ...
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(79);
        currentIssue.status = "RESOLVED";
        currentIssue.priority = "P3";
        currentIssue.resolution = "WONTFIX";
        currentIssue.component = "glazedlists";
        currentIssue.version = "0.9.1";
        currentIssue.assignedTo = "jessewilson";
        currentIssue.subcomponent = "core";
        ...
        currentIssue.issueType = "DEFECT";
        currentIssue.qaContact = "jessewilson";
        currentIssue.shortDescription = "issues.xml is 104 KB";
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "Glazed Lists .jar file includes a 104 KB file \"issues.xml\" for the demo applet.\n\nIncluding this file is okay. Including 104 KB is ridiculous.\n\nTrim the file and update it to the latest issue set!";
        currentIssue.getDescriptions().add(description);
        description = null;
        description = new Description();
        description.who = "jessewilson";
        description.when = null;
        description.text = "This is actually only 7KB compressed, but trimming it won't hurt anyway.\n\nAnd updating it is definitely worthwhile.";
        currentIssue.getDescriptions().add(description);
        description = null;
        issues.add(currentIssue);
        currentIssue = null;
        currentIssue = new Issue();
        currentIssue.id = new Integer(95);
        currentIssue.status = "RESOLVED";
        currentIssue.priority = "P3";
        currentIssue.resolution = "FIXED";
        currentIssue.component = "glazedlists";
     ...
     */
    static class Description implements TextFilterable {
    ...
    static class IssueHandler extends AbstractSimpleElementHandler {
        ...
        public void addFieldAndValue(String currentField, String value) {
            ...
            if(currentField.equals("issue_id")) System.out.println("currentIssue.id = new Integer(" + Integer.valueOf(value) + ");"); 
            else if(currentField.equals("issue_status")) System.out.println("currentIssue.status = \"" + escapeToJava(value) + "\";");
            else if(currentField.equals("priority")) System.out.println("currentIssue.priority = \"" + escapeToJava(value) + "\";");
            else if(currentField.equals("resolution")) System.out.println("currentIssue.resolution = \"" + escapeToJava(value) + "\";");
            else if(currentField.equals("component")) System.out.println("currentIssue.component = \"" + escapeToJava(value) + "\";");
            else if(currentField.equals("version")) System.out.println("currentIssue.version = \"" + escapeToJava(value) + "\";");
            else if(currentField.equals("assigned_to")) System.out.println("currentIssue.assignedTo = \"" + escapeToJava(value) + "\";");
            else if(currentField.equals("subcomponent")) System.out.println("currentIssue.subcomponent = \"" + escapeToJava(value) + "\";");
            else if(currentField.equals("issue_type")) System.out.println("currentIssue.issueType = \"" + escapeToJava(value) + "\";");
            else if(currentField.equals("qa_contact")) System.out.println("currentIssue.qaContact = \"" + escapeToJava(value) + "\";");
            else if(currentField.equals("short_desc")) System.out.println("currentIssue.shortDescription = \"" + escapeToJava(value) + "\";");
        }
    ...
    static class DescriptionHandler extends AbstractSimpleElementHandler {
        ...
        public void addFieldAndValue(String currentField, String value) {
            ...
            // print the executed Java command
            if(currentField.equals("who")) System.out.println("description.who = \"" + escapeToJava(value) + "\";");
            else if(currentField.equals("issue_when")) System.out.println("description.when = null;");
            else if(currentField.equals("thetext")) System.out.println("description.text = \"" + escapeToJava(value) + "\";");
        }
    }
