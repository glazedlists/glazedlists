 ...
 * provided matchersource's filters apply (but not if both match). If no delegate {@link Matcher
 ...
 */
public final class XorMatcherSource extends CompositeMatcherSource implements MatcherSourceListener {
	protected XorMatcherSource(Matcher initial_matcher) {
		super(initial_matcher);	// TODO: implement
	}
	//    /**
//     * {@inheritDoc}
//     */
//    public XorMatcherSource(Matcher one, Matcher two) {
//        super(one, two);
//    }
//
//    /**
//     * {@inheritDoc}
//     */
//    public XorMatcherSource(Matcher[] matchers) {
//        super(matchers);
//    }
//
//    /**
//     * {@inheritDoc}
//     */
//    public XorMatcherSource(EventList matcher_list) {
//        super(matcher_list);
//    }
//
