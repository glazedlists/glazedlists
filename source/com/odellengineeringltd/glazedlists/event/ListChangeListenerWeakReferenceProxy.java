...
/**
 * This class is a proxy to another ListChangeListener that may go out of
 * scope without explicitly removing itself from the source list's set of
 * listeners. 
 *
 * <p>ListChangeListenerWeakReferenceProxy exists to solve a garbage
 ...
 *
 * <p>This problem is solved by ListChangeListenerWeakReferenceProxy. Instead
 ...
 */
public final class ListChangeListenerWeakReferenceProxy implements ListChangeListener {

    /** a weak reference the target ListChangeListener */
    ...
    public void notifyListChanges(ListChangeEvent listChanges) {
        ListChangeListener proxyTarget = (ListChangeListener)proxyTargetReference.get();
