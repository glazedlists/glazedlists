 ...
 */
package com.odellengineeringltd.glazedlists.util.concurrent;

// for keeping threads in hash maps
import java.util.*;

/**
 * A ReadWriteLock implementation that is compatable with Java 1.2 and better. This
