 ...
 */
public abstract class AbstractEventListTypeTest extends HibernateTestCase {

    protected abstract Class<?> getExpectedPersistentCollectionClass();
    ...
    private void doTestValueCollection(boolean lazy) {
        ...
        assertEquals(getExpectedPersistentCollectionClass(), u.getNickNames().getClass());
    ...
    private void doTestOneToManyUniDirectionalAssociation(boolean lazy) {
        ...
        assertEquals(getExpectedPersistentCollectionClass(), u.getEmailAddresses().getClass());
    ...
    private void doTestManyToManyAssociation(boolean lazy) {
        ...
        if (lazy) {
            ...
            // get() calls only optimized for lists not bags
            if (getExpectedPersistentCollectionClass() == PersistentEventList.class) {
        ...
        assertEquals(getExpectedPersistentCollectionClass(), u.getRoles().getClass());
