...
public class PersistentMapTest extends TestCase {
    ...
    public static Chunk chunkify(Object value) throws IOException {
        ...
        ByteCoderFactory.serializable().encode(value, data.getOutputStream());
    ...
    public static Object deChunkify(Chunk chunk) throws IOException {
        ...
        return ByteCoderFactory.serializable().decode(data.getInputStream());
    }
    ...
    public void testFlush() throws IOException {
        ...
        Bufferlo data = new Bufferlo();
        ByteCoderFactory.serializable().encode(new long[4000], data.getOutputStream()); // 4000 x 8 bytes ~ 32000 bytes
        for(int i = 0; i < 50; i++) {
